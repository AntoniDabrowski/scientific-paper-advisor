...
def trim_data_for_quantiles(df):
    ...
    drop_percent(citation_count[0],0.838)
...
if __name__ == '__main__':
    df = pd.read_csv(open('../data/edition_2/semanticscholar_results2_preprocessed.csv', encoding='UTF-8'))
    compute_quantiles(df)
    ...
    trimmed_df.to_csv('../data/edition_2/semanticscholar_results2_quantiles.csv',index=False)